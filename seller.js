...
const Base_URL = "http://prod-seller.irantic.com/"
...
const schedules = [956040, 956043, 956046, 956049, 956052, 956054, 956057, 956060, 956063, 956066, 956069, 956072];
    ...
    group('Reserve', function () {
        ...
        if (freeSeats.length) {
            ...
            response = http.post(
                ...
                `{"seat_ids":[${randSeats}],"schedule_id":"${schedule}","block_id":"1323"}`, {
                    headers: {
                        accept: 'application/json',
                        authorization: 'Bearer ' + token,
            ...
            if (response.json().success === false) {
                ...
                response = http.post(
                    Base_URL + 'api/v1/order/reserve',
                    `{"seat_ids":[${randSeats}],"schedule_id":"${schedule}","block_id":"1324"}`, {
                        headers: {
                            accept: 'application/json',
                            authorization: 'Bearer ' + token,
                            'content-type': 'application/json; charset=UTF-8',
